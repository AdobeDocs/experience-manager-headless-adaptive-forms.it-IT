...
description: Scopri come abilitare i moduli adattivi headless su AEM 6.5 Forms con la guida dettagliata di Adobe. Questo tutorial illustra il processo, semplificando l’integrazione di questa potente funzione nel sito web e migliorando l’esperienza utente.
...
1. Esegui il seguente comando per creare un progetto basato su Archetipo 41 di AEM:
   ...
   * Aggiorna il comando in modo che rifletta i valori specifici per l&#39;ambiente, inclusi appTitle, appId e groupId. Impostare inoltre i valori per includeFormsenrollment su `y`. Se si utilizza Forms Portal, impostare l&#39;opzione _includeExamples=y_ per includere nel progetto i componenti core di Forms Portal.
